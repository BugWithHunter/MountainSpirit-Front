...
|:---:|---|
|강지현||
|정건일| 본인의 생각을 표현하는 방식과 주변사람들의 의견을 수용하는 사상에서 2번째 프로젝트 이후부터 감명받아왔습니다
회원에 대한 인증과 인가에 대한 시스템 구축을 시작으로 프론트에서 로그인과 로그아웃 시스템과 권한부여와 함께 프로젝트 체계를 설계하여 팀원들의 전반적인 학습에 도움을 주었습니다 |
|윤서진||
|민수현||
<br>
...
|:---:|---|
|강형규||
|정건일| 크루와 크루구성원에 대한 회원관리와 히스토리 저장을 위한 db를 설계하고 db를 기반으로 한 백에서 안정적인 시스템흐름과 코드 패턴에 대한 고민이 많이 엿보였습니다
예비군 훈련으로 이번 프로젝트인 프론트 구현에 시간이 많이 부족했음에도 불구하고 좋은 성과를 보여주었습니다 |
|윤서진||
|민수현||
<br>
...
|강형규|  | 
|강지현|  |
|정건일| 게시판 구현에 대해서 백설계 및 프론트 담당을 맡았고 발표작업을 위한 서류마련을 해주었습니다
게시판 구현이 조금 늦게 끝나서 신고담당을 맡은 제가 프론트 이해가 부족하여 게시판 신고하는 기능을 추가하지 못했습니다
설계와 작업에 있어서 좀 더 이야기를 많이 했어야하는 아쉬움이 남습니다
취업을 위해서 전과했다고 했는데 주변 사람들의 실력의 이유로 본인이 나아갈길이 흔들리지 않기를 바랍니다 |
|민수현| |
<br>
